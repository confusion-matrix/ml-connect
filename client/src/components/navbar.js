    ...
    <div>
      <Navbar className="px-3 navbar justify-content-between" style={color}>
        ...
        <NavLink className="navbar-brand justify-content-between" to="/">
          {/* change icon */}
          <img style={{ width: "17rem" }} src={logo} alt="ourLogo"></img>
        </NavLink>
         ...
         <div className='flex-end py-2 mx-2 fader' style={box}>   
              ...
              <Navbar.Collapse className="col hove" style={statica} id="navbar">
                <Nav className="ml-auto">
                  ...
                  {Auth.loggedIn() ? (
                    <Container>
                      <p className="text-danger">{userData.email}</p>
                      <Nav.Link style={whiteText} onClick={Auth.logout}>
                        Logout
                      </Nav.Link>
                    </Container>
                  ) : (
          ...
          <Modal.Header closeButton>
            <Modal.Title id="signup-modal">
              <Nav fill variant="tabs">
                <Nav.Item>
                  <Nav.Link eventKey="login" className="logsign">
                    Login
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey="signup" className="logsign">
                    Sign Up
                  </Nav.Link>
                </Nav.Item>
              </Nav>
